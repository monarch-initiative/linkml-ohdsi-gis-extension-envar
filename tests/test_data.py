...
import linkml_ohdsi_gis_extension_envar.datamodel.linkml_ohdsi_gis_extension_envar
...
def test_valid_data_files(filepath):
    ...
    tgt_class = getattr(
        linkml_ohdsi_gis_extension_envar.datamodel.linkml_ohdsi_gis_extension_envar,
        target_class_name,
    )
